...
public class NiuDan_LB_ND {
	...
	public static void main(String[] args) throws Exception {
		...
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("input[value=\"扭蛋礼包\"]")).click();
		...
		for(int i=1;i<read.rows;i++){
			...
			driver.findElement(By.id("ClassID")).clear();
			driver.findElement(By.id("ClassID")).sendKeys(read.readColumn("永久礼包顺序", i));
			...
			driver.findElement(By.id("Pro")).clear();
			driver.findElement(By.id("Pro")).sendKeys(read.readColumn("概率", i));
