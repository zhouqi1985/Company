...
public class Laba_HGG {
	...
	public static void main(String[] args) throws Exception {
		...
		read.getExcel("E:\\Data\\labapoints.xls", "gg");
		Thread.sleep(1000);
		...
		for(int i=1;i<read.rows;i++){
			...
			Thread.sleep(1000);
			System.out.println(count+"."+read.readColumn("礼包名称", i)+" 礼包是否勾选公告成功:"+driver.findElement(By.className("red")).getText().trim().equals("Success"));
