...
public class hongbao_JD {
	...
	public static void main(String[] args) throws Exception {
		...
		Thread.sleep(500);
		driver.findElement(By.cssSelector("input[value=\"公共节点概率\"]")).click();
		readExcel read =new readExcel();
		read.getExcel("E:\\Data\\HB.xls", "jd");
		for(int i=1;i<read.rows;i++){
			count++;
			if(read.readColumn("分类", i).equals("")) break;
			Thread.sleep(500);
			driver.findElement(By.cssSelector("input[value=\"新增概率配置\"]")).click();
			Thread.sleep(500);
			Select MachineId=new Select(driver.findElement(By.id("PublicType")));
			MachineId.selectByVisibleText(read.readColumn("分类", i));
			Thread.sleep(500);
