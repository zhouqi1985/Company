...
public class Toupiao_H {
	...
	public static void main(String[] args) throws Exception {
		...
		read1.getExcel("E:\\Data\\toupiao_H.xls", "投票组内容");
		for(int i=1;i<read1.rows;i++){
			count++;
			if(read1.readColumn("投票主题", i).equals("")) break;
			Thread.sleep(1000);
			driver.findElement(By.id("GroupID")).sendKeys(read1.readColumn("组名", i));
			...
			read2.getExcel("E:\\Data\\toupiao_H.xls", "组选项");
				for(int n=1;n<read2.columns-1;n++)
				{
					int m=n+1;
					String option=read2.readColumn("选项"+n,i);
					String nextoption=read2.readColumn("选项"+m,i);
					if(!option.isEmpty())
